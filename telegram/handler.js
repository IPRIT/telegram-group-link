...
function onHelp(message) {
    var text = 'این راهنما به شما کمک می کند با امکانات این روبوت بیشتر آشنا شوید.\n\n' +
        ...
        '1) دریافت کد یکبار مصرف برای اتصال گروه های دیگر به این گروه\n' +
        ...
        'مثال: شما روبوت را به گروه الف اضافه می کنید. اکنون شما مدیر روبوت در این گروه هستید. حال می توانید با ارسال دستور /connect کد اتصال را دریافت کرده و برای دوست خود که عضو گروه ب است بفرستید. دوست شما باید روبوت را به گروه ب اضافه کند (به این ترتیب، ایشان مدیر روبوت در گروه ب خواهند بود). وقتی ایشان کد را در گروه ب ارسال کند دو گروه به هم متصل خواهند شد.\n' +
        'مدیران روبوت در هر یک از گروههای الف و ب می توانند ارتباط این دو گروه را حذف کنند. \n' +
        ...
        'لیست دستورها: \n' +
        '/connect — دریافت کد اتصال یکبار مصرف. این کد فقط برای مدیر روبوت در گروه قابل استفاده است *\n' +
